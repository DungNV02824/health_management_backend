...
# For dev with custom domain: https://dev.api.vhealth.io.net/api/v1/scheduler/hello-world
# For dev without custom domain: https://vhealth-backend-dev-HASH.asia-southeast1.run.app/api/v1/scheduler/hello-world
scheduler_endpoint_url    = "https://dev.api.vhealth.io.net/api/v1/scheduler/hello-world"
